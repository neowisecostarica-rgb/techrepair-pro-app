...
export const COMMAND_POLICIES = Object.freeze({
  ...
  'CP-PROV-001': policy({ endpoint: 'provisionTenant', principalClasses: ['PLATFORM_ADMIN'], capability: null, authorityContract: 'PLATFORM_PROVISIONING', scope: 'NEW_ORGANIZATION', relationship: 'ORG_RESOURCE', precondition: 'CANONICAL_MANIFEST_AND_READINESS_VALIDATION', writer: 'provisionTenant', auditOwner: 'AuditEvent' }),

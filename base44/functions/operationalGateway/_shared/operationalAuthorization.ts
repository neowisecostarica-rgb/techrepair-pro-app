...
export const OPERATIONAL_ENTITY_POLICIES = Object.freeze({
  ...
  Branch: { read: ALL_OPERATIONAL_ROLES, create: [], update: [], delete: [], scope: 'branch' },
  ...
  EnterpriseOffboarding: { read: ['ORG_ADMIN','BRANCH_ADMIN'], create: [], update: [], delete: [], scope: 'enterprise_branch' },
  OffboardingAccessItem: { read: ['ORG_ADMIN','BRANCH_ADMIN'], create: [], update: [], delete: [], scope: 'enterprise_branch' },
  EnterpriseOnboarding: { read: ['ORG_ADMIN','BRANCH_ADMIN'], create: [], update: [], delete: [], scope: 'enterprise_branch' },
  OnboardingAccessItem: { read: ['ORG_ADMIN','BRANCH_ADMIN'], create: [], update: [], delete: [], scope: 'enterprise_branch' },
...
const FORBIDDEN_MUTATION_FIELDS = new Set([
  ...
  'reactivated_at',
  'reactivated_by',
  'lifecycle_operation_key',
  'lifecycle_request_fingerprint',
  'lifecycle_action',
  'lifecycle_committed_at',
  'last_sale_id',

  ...
  return (
    <div className="max-w-7xl mx-auto space-y-5">
      ...
      <div className={`grid grid-cols-2 ${canReadCommercial && canReadTechnicalSignals ? 'lg:grid-cols-4' : 'lg:grid-cols-3'} gap-3`}>
        ...
        {canReadCommercial && !canReadTechnicalSignals && <Card className="border-slate-200 shadow-sm"><CardContent className="p-4"><ShieldCheck className="w-4 h-4 text-slate-400 mb-2"/><p className="text-2xl font-bold">{activeWarranties.length}</p><p className="text-xs text-slate-500">Garantías vigentes</p></CardContent></Card>}
      </div>

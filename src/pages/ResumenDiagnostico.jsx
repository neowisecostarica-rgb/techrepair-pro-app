...
import { Printer, FileText, ArrowLeft, Send, Wrench, Calendar, CheckCircle2, AlertTriangle } from 'lucide-react';
...
export default function ResumenDiagnostico() {
  ...
  const handleGenerarCotizacion = () => {
    // Redirigir a OrdenesTrabajo con modal de cotización
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-slate-50 p-6 no-print">
        {/* Barra de Acciones */}
        <div className="max-w-5xl mx-auto mb-6 flex gap-3 justify-end page-actions">
          <Button
      ...
      <div className="max-w-5xl mx-auto bg-white p-8 shadow-lg rounded-xl">
        ...
        <div className="seccion-tecnica-interna no-print mb-8">
